...
import { LintSettings, IConfigurations, propertiesPlatform } from '../../server/src/settings';
...
describe('c_cpp_properties.json unit-tests', () => {
    ...
    describe('GIVEN an opened workspace', () => {
        ...
        test('it should handle glob expansion of includePaths setting', async () => {
            // WHEN
            let config: LintSettings = (await RobustPromises.retry(42, // # of attempts
                1000, // delay between retries
                1000, // timeout for a try
                () => vscode.commands.executeCommand('verbosefeedback.getLocalConfig', document))) as LintSettings;
