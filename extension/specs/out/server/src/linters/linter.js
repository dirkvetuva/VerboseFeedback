...
class Linter {
    ...
    cascadeCommonSettings(key) {
        let checkKey = (item) => {
            return this.settings['verbosefeedback'][key].hasOwnProperty(item) &&
                this.settings['verbosefeedback'][key].hasOwnProperty(item) !== null &&
                this.settings['verbosefeedback'][key][item] !== null;
        };
        let maybe = (orig, maybeKey) => {
            if (checkKey(maybeKey)) {
                if (_.isArray(orig)) {
                    return this.settings['verbosefeedback'][key][maybeKey];
                }
